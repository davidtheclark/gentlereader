...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Announcement.date'
        db.delete_column(u'anthologist_announcement', 'date')

        # Adding field 'Announcement.date_entered'
        db.add_column(u'anthologist_announcement', 'date_entered',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 22, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ExternalLink.date_entered'
        db.add_column(u'anthologist_externallink', 'date_entered',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 22, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Announcement.date'
        db.add_column(u'anthologist_announcement', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 7, 22, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Announcement.date_entered'
        db.delete_column(u'anthologist_announcement', 'date_entered')

        # Deleting field 'ExternalLink.date_entered'
        db.delete_column(u'anthologist_externallink', 'date_entered')
