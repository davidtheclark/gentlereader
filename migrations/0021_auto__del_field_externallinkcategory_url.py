...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalLinkCategory.url'
        db.delete_column('anthologist_externallinkcategory', 'url')


    def backwards(self, orm):
        # Adding field 'ExternalLinkCategory.url'
        db.add_column('anthologist_externallinkcategory', 'url',
