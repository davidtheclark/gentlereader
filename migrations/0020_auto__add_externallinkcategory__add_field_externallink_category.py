...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalLinkCategory'
        db.create_table('anthologist_externallinkcategory', (
        ...
        db.send_create_signal('anthologist', ['ExternalLinkCategory'])

        # Adding field 'ExternalLink.category'
        db.add_column('anthologist_externallink', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['anthologist.ExternalLinkCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExternalLinkCategory'
        db.delete_table('anthologist_externallinkcategory')

        # Deleting field 'ExternalLink.category'
        db.delete_column('anthologist_externallink', 'category_id')
