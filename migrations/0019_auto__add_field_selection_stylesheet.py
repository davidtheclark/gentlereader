...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Selection.stylesheet'
        db.add_column('anthologist_selection', 'stylesheet',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Selection.stylesheet'
        db.delete_column('anthologist_selection', 'stylesheet')
