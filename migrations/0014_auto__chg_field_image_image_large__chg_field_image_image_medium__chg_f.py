...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.image_large'
        db.alter_column(u'anthologist_image', 'image_large', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='static/anthologist/images', null=True))

        # Changing field 'Image.image_medium'
        db.alter_column(u'anthologist_image', 'image_medium', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='static/anthologist/images', null=True))

        # Changing field 'Image.image_small'
        db.alter_column(u'anthologist_image', 'image_small', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='static/anthologist/images', null=True))

    def backwards(self, orm):

        # Changing field 'Image.image_large'
        db.alter_column(u'anthologist_image', 'image_large', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Image.image_medium'
        db.alter_column(u'anthologist_image', 'image_medium', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Image.image_small'
        db.alter_column(u'anthologist_image', 'image_small', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'anthologist.image': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_large': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'static/anthologist/images'", 'null': 'True', 'blank': 'True'}),
            'image_medium': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'static/anthologist/images'", 'null': 'True', 'blank': 'True'}),
            'image_small': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'static/anthologist/images'", 'null': 'True', 'blank': 'True'}),
