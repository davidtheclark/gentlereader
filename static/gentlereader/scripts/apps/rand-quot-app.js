...
define(['backbone', 'models/rand-quot-set', 'views/rand-quot-view', 'lib/matchMedia', 'lib/hyphenator', 'utils/isElementInViewport'], function(Backbone, RandQuotSet, RandQuotView, matchMedia, Hyphenator, isElementInViewport) {
