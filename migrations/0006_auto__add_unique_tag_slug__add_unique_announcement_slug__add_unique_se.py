...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'anthologist_tag', ['slug'])

        # Adding unique constraint on 'Announcement', fields ['slug']
        db.create_unique(u'anthologist_announcement', ['slug'])

        # Adding unique constraint on 'Selection', fields ['slug']
        db.create_unique(u'anthologist_selection', ['slug'])

        # Adding unique constraint on 'Author', fields ['slug']
        db.create_unique(u'anthologist_author', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Author', fields ['slug']
        db.delete_unique(u'anthologist_author', ['slug'])

        # Removing unique constraint on 'Selection', fields ['slug']
        db.delete_unique(u'anthologist_selection', ['slug'])

        # Removing unique constraint on 'Announcement', fields ['slug']
        db.delete_unique(u'anthologist_announcement', ['slug'])

        # Removing unique constraint on 'Tag', fields ['slug']
        db.delete_unique(u'anthologist_tag', ['slug'])
