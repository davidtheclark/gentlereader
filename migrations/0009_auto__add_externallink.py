...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'anthologist_externallink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('info_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'anthologist', ['ExternalLink'])


    def backwards(self, orm):
        # Deleting model 'ExternalLink'
        db.delete_table(u'anthologist_externallink')
    ...
    models = {
        ...
        u'anthologist.externallink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True'}),
