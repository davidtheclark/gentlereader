...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalLink.info_url'
        db.delete_column(u'anthologist_externallink', 'info_url')

        # Adding field 'ExternalLink.url'
        db.add_column(u'anthologist_externallink', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExternalLink.info_url'
        db.add_column(u'anthologist_externallink', 'info_url',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'ExternalLink.url'
        db.delete_column(u'anthologist_externallink', 'url')
