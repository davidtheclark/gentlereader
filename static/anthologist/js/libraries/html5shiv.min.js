...
p="undefined"==typeof q.cloneNode||"undefined"==typeof q.createDocumentFragment||"undefined"==typeof q.createElement}h=p}catch(z){h=l=!0}var g={elements:m.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video",shivCSS:!1!==m.shivCSS,supportsUnknownElements:h,shivMethods:!1!==m.shivMethods,type:"default",shivDocument:w,createElement:v,createDocumentFragment:function(a,b){a||(a=f);if(h)return a.createDocumentFragment();
b=b||j(a);for(var c=b.frag.cloneNode(),d=0,e=s(),g=e.length;d<g;d++)c.createElement(e[d]);return c}};r.html5=g;w(f)})(this,document);