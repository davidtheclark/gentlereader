...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DictionarySource'
        db.create_table('anthologist_dictionarysource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('anthologist', ['DictionarySource'])

        # Adding field 'Tag.dictionary_source'
        db.add_column('anthologist_tag', 'dictionary_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anthologist.DictionarySource'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DictionarySource'
        db.delete_table('anthologist_dictionarysource')

        # Deleting field 'Tag.dictionary_source'
        db.delete_column('anthologist_tag', 'dictionary_source_id')
    ...
    models = {
        ...
        'anthologist.dictionarysource': {
            'Meta': {'object_name': 'DictionarySource'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'anthologist.tag': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'dictionary_source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anthologist.DictionarySource']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info_url': ('django.db.models.fields.URLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
