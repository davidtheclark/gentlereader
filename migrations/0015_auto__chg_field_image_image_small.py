...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'anthologist_image', 'image_small', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Image.image_small'
        db.alter_column(u'anthologist_image', 'image_small', self.gf('django.db.models.fields.FilePathField')(path='static/anthologist/images', max_length=100, null=True))
    ...
    models = {
        ...
        u'anthologist.image': {
            ...
            'image_small': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
