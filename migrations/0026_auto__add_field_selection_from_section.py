...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Selection.from_section'
        db.add_column('anthologist_selection', 'from_section',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Selection.from_section'
        db.delete_column('anthologist_selection', 'from_section')
    ...
    models = {
        ...
        'anthologist.selection': {
            ...
            'from_section': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
