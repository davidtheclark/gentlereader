...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Selection.teaser'
        db.add_column(u'anthologist_selection', 'teaser',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Selection.teaser'
        db.delete_column(u'anthologist_selection', 'teaser')
