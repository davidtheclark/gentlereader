...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.definition'
        db.add_column('anthologist_tag', 'definition',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tag.name'
        db.alter_column('anthologist_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Tag.definition'
        db.delete_column('anthologist_tag', 'definition')


        # Changing field 'Tag.name'
        db.alter_column('anthologist_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
